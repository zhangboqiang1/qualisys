...
int main(int argc, char *argv[])
{
    ...
    string serverAddress = "172.21.101.151"; //"tracking1";		// The address of the computer connected to the Qualisys motion tracking system (ex: "130.75.144.179")
